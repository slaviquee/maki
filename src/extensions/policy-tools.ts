  ...
  pi.registerTool({
    ...
    async execute(_toolCallId, params, _signal, _onUpdate, _ctx) {
      ...
      const lines = [
        ...
        ``,
        `Limits:`,
        `  Transfer per-tx: ${newPolicy.limits.transfer_per_tx_usdc} USDC`,
        `  Transfer daily: ${newPolicy.limits.transfer_daily_usdc} USDC`,
        `  Swap per-tx: ${newPolicy.limits.swap_per_tx_usdc} USDC`,
        `  Swap daily: ${newPolicy.limits.swap_daily_usdc} USDC`,
  ...
  pi.registerTool({
    ...
    async execute(_toolCallId, _params, _signal, _onUpdate, _ctx) {
      ...
      const lines = [
        ...
        ``,
        `Limits:`,
        `  Transfer per-tx: ${policy.limits.transfer_per_tx_usdc} USDC`,
        `  Transfer daily: ${policy.limits.transfer_daily_usdc} USDC`,
        `  Swap per-tx: ${policy.limits.swap_per_tx_usdc} USDC`,
        `  Swap daily: ${policy.limits.swap_daily_usdc} USDC`,
